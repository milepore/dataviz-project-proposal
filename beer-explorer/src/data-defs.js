...
export const column_defs = {
    ...
    lat: { type : 'numeric', hidden : false, filter_type : 'range', description : 'Latitude', range : [ -90, +90 ] },
    lng : { type : 'numeric', hidden : false, filter_type : 'range', description : 'Longitude', range : [ -180, +180 ] },
